...
m_main = Menu("Главное меню", buttons=["Развлечения", "Приложения", "ДЗ", "КМН"])
m_PRIL = Menu("Приложения", buttons=["Калькулятор", "Выход"], parent=m_main)
m_DZ = Menu("ДЗ", buttons=["1 Задание", "2 Задание", "3 Задание", "4 Задание", "5 Задание", "6 Задание", "7 Задание","8 Задание","9 Задание", "Выход"], parent=m_main)
m_KMN = Menu("КМН", buttons=["Камень", "Ножницы", "Бумага", "Старт", "Выход"], parent=m_main)

m_fun = Menu("Развлечения", buttons=["Показать лисичку" ,"Создать ник" ,"Анекдот", "Выход"], parent=m_main)